...
ALTER TABLE commits CHANGE commiter committer INT(11) NOT NULL;
ALTER TABLE commit_data MODIFY item_path VARCHAR(200) NOT NULL COMMENT '提交的某个图片路径，可以由此访问到图片和对应的xml';
